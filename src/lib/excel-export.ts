...
export async function exportFQCOQCExcel(
  ...
  // ── Row 1: Title (height 42, bg MED_BLUE) ──
  ...
  // ── Column widths ──
  const rekapWidths = [8, 12.5, 10, 13, 10, 10, 8.5, 8, 10, 10, 10, 12, 12, 12, 26];
  for (let c = 0; c < totalCols; c++) {
